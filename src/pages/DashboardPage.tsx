      ...
      <div className="space-y-5">
        <Card className="bg-gradient-to-r from-pink-500 to-rose-500 text-white border-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-semibold">Take Care of Yourself</p>
              <p className="text-sm opacity-90">Your wellness matters too</p>
            </div>
          </div>
        </Card>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex justify-between gap-2">
                  {moodEmojis.map((emoji, index) => (
                    <button
                      key={index}
                      onClick={() => setParent1Data({ ...parent1Data, mood: index + 1 })}
              ...
              <div className="flex items-center gap-3">
                ...
                <Input
                  ...
                  onChange={(val) => setParent1Data({ ...parent1Data, sleep: val })}
              ...
              <div className="flex items-start gap-3">
                <BookOpen size={20} className="text-gray-600 flex-shrink-0 mt-3" />
                <Input
                  type="textarea"
                  value={parent1Data.journal}
                  onChange={(val) => setParent1Data({ ...parent1Data, journal: val })}
              ...
              <Button onClick={() => saveWellness('parent1', parent1Data)} fullWidth>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex justify-between gap-2">
                    {moodEmojis.map((emoji, index) => (
                      <button
                        key={index}
                        onClick={() => setParent2Data({ ...parent2Data, mood: index + 1 })}
                        className={`flex-1 p-3 rounded-xl border-2 transition-all text-2xl ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Input
                    ...
                    onChange={(val) => setParent2Data({ ...parent2Data, sleep: val })}
                    placeholder="Hours of sleep"
                    className="flex-1"
                  />
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <Input
                    ...
                    onChange={(val) => setParent2Data({ ...parent2Data, journal: val })}
                    placeholder="What's on your mind? (optional)"
                    rows={3}
                    className="flex-1"
                  />
                ...
                <Button onClick={() => saveWellness('parent2', parent2Data)} fullWidth>
        ...
        <Card className="bg-blue-50 border-blue-200">
          <p className="text-sm text-blue-800 text-center">
            Remember: Taking care of yourself isn't selfish. You can't pour from an empty cup. Be kind to yourself today.
          </p>
        </Card>
      </div>
    </Layout>
