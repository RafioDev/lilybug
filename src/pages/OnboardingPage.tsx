  ...
  const handleSubmit = async () => {
    try {
      await profileService.createOrUpdateProfile({
        ...
        baby_birthdate: formData.babyBirthdate,
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Welcome to BabyCare</h1>
        ...
        <Card padding="lg">
          {step === 1 && (
            <div className="space-y-5">
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-2">Let's get started</h2>
              ...
              <Input
                ...
                onChange={(val) => setFormData({ ...formData, babyBirthdate: val })}
                required
          ...
          {step === 2 && (
            <div className="space-y-5">
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-2">Parent Information</h2>
              ...
              <Input
                ...
                onChange={(val) => setFormData({ ...formData, parent1Name: val })}
              ...
              <Input
                ...
                onChange={(val) => setFormData({ ...formData, parent2Name: val })}
