...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'font-medium rounded-xl transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800'

  const variantStyles = {
    primary:
      'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-sm hover:shadow-md hover:from-blue-600 hover:to-blue-700 focus:ring-blue-500',
    secondary:
      'bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-sm hover:shadow-md hover:from-emerald-600 hover:to-emerald-700 focus:ring-emerald-500',
    outline:
    ...
    danger:
      'bg-gradient-to-r from-rose-500 to-rose-600 text-white shadow-sm hover:shadow-md hover:from-rose-600 hover:to-rose-700 focus:ring-rose-500',
  }
